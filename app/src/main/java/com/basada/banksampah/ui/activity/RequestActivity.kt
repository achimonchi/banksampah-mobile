...
import com.basada.banksampah.databinding.ActivityRequestBinding
import com.basada.banksampah.model.entity.SampahKategoryItem
import com.basada.banksampah.ui.viewmodel.RequestViewModel
import com.basada.banksampah.utill.MinMax
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        requestViewModel.action.observe(this, Observer { action ->
            when (action) {
                ...
                RequestViewModel.ACTION_REQUEST_TOO_MIN -> tooMin()
                RequestViewModel.ACTION_REQUEST_WEIGHT_NULL -> weightNull()
            }
        })
    }

    private fun weightNull() {
        Toast.makeText(this, "Estimasi sampah tidak boleh kosong !", Toast.LENGTH_SHORT).show()
    }

    private fun tooMin() {
        Toast.makeText(this, "Berat Estimasi kurang dari minimal !", Toast.LENGTH_SHORT)
            .show()
    }
